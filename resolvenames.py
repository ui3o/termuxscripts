...
def repleceVideo(videoPath: str, outPath: str, model: str, counter):
    ...
    run(CMD_PHONE, ["ffmpeg", "-i", videoPath, "-map_metadata", "0", "-metadata", f"Creation_Time=2024:03:30 15:58:01.000000Z","-metadata", f"Encoded_Hardware_Name={model}", "-metadata", "Encoded_Hardware_CompanyName=..::", "-movflags", "use_metadata_tags", "-c", "copy",  outPath],
